    ...
    <div className="min-h-screen bg-hero flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-display text-primary-foreground tracking-wide">CREAR CUENTA</h1>
          <p className="text-primary-foreground/60 font-body mt-2">Únete y compite con tus amigos</p>
        </div>
