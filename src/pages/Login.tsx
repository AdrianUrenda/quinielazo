...
const Login = () => {
  ...
  const redirectTo = (location.state as any)?.from || "/groups";
    ...
    <div className="min-h-screen bg-hero flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-display text-primary-foreground tracking-wide">INICIAR SESIÓN</h1>
          <p className="text-primary-foreground/60 font-body mt-2">Accede a tus grupos y predicciones</p>
        </div>

        <div className="bg-card rounded-xl p-8 shadow-xl">
          <Button
            variant="outline"
            className="w-full mb-6 h-12 font-body"
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-card text-muted-foreground font-body">o con email</span>
            </div>
          </div>
