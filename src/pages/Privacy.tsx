    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container max-w-[800px] mx-auto px-4 font-body">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">1. Responsable del tratamiento de datos</h2>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">2. Datos personales que recopilamos</h2>
          <p className="mb-4 text-primary-foreground/80 leading-relaxed">Recopilamos los siguientes datos personales:</p>

          <h3 className="font-display text-lg text-primary-foreground mt-6 mb-2">Datos proporcionados directamente por ti:</h3>
          ...
          <h3 className="font-display text-lg text-primary-foreground mt-6 mb-2">Datos generados por el uso de la Plataforma:</h3>
          <ul className="list-disc pl-6 mb-4 text-primary-foreground/80 space-y-1">
          ...
          <h3 className="font-display text-lg text-primary-foreground mt-6 mb-2">Datos de pago:</h3>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">3. Finalidades del tratamiento</h2>
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">4. Transferencia de datos a terceros</h2>
          <p className="mb-4 text-primary-foreground/80 leading-relaxed">
          ...
          <div className="overflow-x-auto mb-6">
            <table className="w-full text-sm text-primary-foreground/80 border border-border rounded-md">
              <thead>
                <tr className="bg-muted/30">
                  <th className="text-left p-3 border-b border-border font-semibold text-primary-foreground">Proveedor</th>
                  <th className="text-left p-3 border-b border-border font-semibold text-primary-foreground">Finalidad</th>
                  <th className="text-left p-3 border-b border-border font-semibold text-primary-foreground">País</th>
                </tr>
              </thead>
              <tbody>
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">5. Cookies y tecnologías de seguimiento</h2>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">6. Seguridad de los datos</h2>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">7. Derechos ARCO</h2>
          <p className="mb-4 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">8. Eliminación de cuenta y datos</h2>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">9. Menores de edad</h2>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">10. Cambios a este Aviso</h2>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
          ...
          <h2 className="font-display text-xl text-primary-foreground mt-10 mb-3">11. Autoridad competente</h2>
          <p className="mb-6 text-primary-foreground/80 leading-relaxed">
