    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container max-w-[800px] mx-auto px-4 font-body text-foreground">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">1. Descripción del servicio</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">2. Registro y cuenta de usuario</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">3. Creación de grupos y pagos</h2>
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">4. Grupo Demo</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">5. Sistema de predicciones y puntuación</h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">6. Responsabilidades del Administrador de grupo</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">7. Conducta del usuario</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">8. Propiedad intelectual</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">9. Política de reembolsos</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">10. Limitación de responsabilidad</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">11. Modificaciones</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">12. Ley aplicable</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
          ...
          <h2 className="font-display text-xl text-foreground mt-10 mb-3">13. Contacto</h2>
          <p className="mb-6 text-muted-foreground leading-relaxed">
